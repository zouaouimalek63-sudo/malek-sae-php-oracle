...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['id'])) {
    ...
    $stid = oci_parse($conn, "SELECT * FROM intermittent  WHERE ID_INTERMITTENT = :id");
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['modifier'])) {
    $id = $_POST['id'];
    $new_id = isset($_POST['ID_INTERMITTENT']) && !empty($_POST['ID_INTERMITTENT']) ? $_POST['ID_INTERMITTENT'] : $id;
    ...
    $update_stid = oci_parse($conn, "UPDATE intermittent SET ID_INTERMITTENT = :new_id,NOM=:NOM ,PRENOM = :PRENOM, ADRESSE = :ADRESSE WHERE ID_INTERMITTENT = :id");
...
<head>
    ...
    <title>Modifier un intermittent 🎅</title>
...
<div class="container">
    <h2 class="text-center">🎄 Modifier un intermittent 🎄</h2>
    <?php echo $message; ?>

    <!-- Formulaire de recherche -->
    <form method="POST">
        <div class="mb-3">
            <label class="form-label">ID intermittent (Obligatoire) 🎅</label>
    ...
    <?php if ($req_actuel): ?>
        ...
        <form method="POST" class="mt-4">
            <input type="hidden" name="id" value="<?php echo htmlentities($req_actuel['ID_INTERMITTENT']); ?>">

            <div class="mb-3">
                <label class="form-label">ID Actuel : <?php echo htmlentities($req_actuel['ID_INTERMITTENT']); ?> 🎅</label>
            ...
            <div class="mb-3 hidden" id="champs-new-id">
                ...
                <input type="text" class="form-control" name="ID_INTERMITTENT">
            </div>
